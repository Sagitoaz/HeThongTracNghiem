1.    Mục tiêu:
Xây dựng giao diện người dùng thân thiện và dễ sử dụng cho một hệ thống thi trắc nghiệm trực tuyến.
2.    Yêu cầu chung:
...
3.    Yêu cầu cụ thể 
•    Thiết kế giao diện trước, sử dụng Figma, hoặc các công cụ tương ứng
•    Thực thi theo 2 cách và so sánh đánh giá
      o    Viết code manually (yêu cầu viết trước)
      o    Vibe coding, sử dụng các AI tool nói chung như Claude, Codex, hoặc Gemini hoặc các tool AI cho FE như Google Antigravity ... 
4.    Thời gian
•    Buổi đầu hoàn thành thiết kế trên figma và/hoặc ít nhất 1 trang
